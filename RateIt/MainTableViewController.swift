...
class MainTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let image = UIImage(named: itemsImages[indexPath.row]) { cell.thumbnailImageView.image = image
        ...
        cell.thumbnailImageView.image = UIImage(named: itemsImages[indexPath.row])
        
        cell.mainFirstLbl.text = itemsNames[indexPath.row]
